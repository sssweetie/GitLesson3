...
Строка для конфикта, ветка_4, строка 1
Строка для конфликта, ветка_4, строка 2
Подготовка к конфликту, ветка №4. Нужно больше слов.
В пятой ветке сделали изменения по масштабнее в самой инструкции по Git, чтобы наверняка вызвать конфликт.
